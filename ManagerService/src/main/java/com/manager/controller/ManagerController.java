...
public class ManagerController<CustomerAccounts> {
	...
	@GetMapping("/all")
	public ResponseEntity <CustomerAccounts> displayAllCustomers() {

		ResponseEntity<?> resp = null;

		List<CustomerAccounts> c = (List<CustomerAccounts>) service.displayAllCustomers();

		resp = new ResponseEntity<List<CustomerAccounts>>(c, HttpStatus.FOUND);

		return (ResponseEntity<CustomerAccounts>) resp;
	}
